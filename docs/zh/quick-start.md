...
> address 和 privateKey 可点击自动生成按钮生成  
> voteCount 支持范围为 0 - 9223372036854775807  
> balance 范围为-9223372036854775808 至 9223372036854775807 ，为保证部署成功，请按照取值内范围填写
...
在节点详情页，用户可以点击删除按钮对未部署的节点可以进行删除
